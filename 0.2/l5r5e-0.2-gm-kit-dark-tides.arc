...
# NPC stat blocks) is in l5r5e-0.2-gm-kit-mechanics.ttrpg.
...
ARC "L5R5e_DarkTides" {
    ...
    CAST {
        ...
        # Stat blocks in l5r5e-0.2-gm-kit-mechanics.ttrpg
        ...
        DEF ^"Kasuga Yumiko" #yumiko {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Kasuga Yumiko, Renegade Samurai"
        }
        ...
        DEF ^"Boss Yaguro" #yaguro {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Boss Yaguro, Gang Leader"
        }
        ...
        DEF ^"Azif the Smooth" #azif {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Azif the Smooth, Gaijin Smuggler"
        }
        ...
        DEF ^"Kitsu Sokori" #sokori {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Kitsu Sokori, Maho-Tsukai"
        }
        ...
        DEF ^"Gaku" #gaku {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Gaku, Maho Apprentice"
        }
        ...
        DEF ^"Boss Hana" #hana {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Boss Hana, Gang Leader"
        }
        ...
        DEF ^"Boss Kizo" #kizo {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Boss Kizo, Gang Leader"
        }
        ...
        DEF ^"Kasuga Mugatsu" #mugatsu {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Kasuga Mugatsu, Governor"
        }
        ...
        DEF ^"Kasuga Mikoto" #mikoto {
            ...
            REF "l5r5e-0.2-gm-kit-mechanics.ttrpg::Kasuga Mikoto, Magistrate"
        }
